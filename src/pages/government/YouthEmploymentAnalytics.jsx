...
const YouthEmploymentAnalytics = () => {
  const { overview, models, insights, history, loading, error, refresh } = useGovernment();
  ...
  return (
    <PageContainer
      ...
      subtitle="Unemployment and opportunity trends"
      loading={loading}
      actions={[{ label: 'Refresh', onClick: refresh, variant: 'contained' }]}
      breadcrumbs={[
        { label: 'Government', path: '/government' },
        { label: 'Youth Employment Analytics', path: '/government/youth-employment-analytics' },
      ]}
    >
      {error && (
...
export default YouthEmploymentAnalytics;
