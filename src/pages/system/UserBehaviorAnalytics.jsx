...
const UserBehaviorAnalytics = () => {
  const { overview, models, insights, history, loading, error, refresh } = useSystem();
  ...
  return (
    <PageContainer
      ...
      subtitle="Engagement flow analysis"
      loading={loading}
      actions={[{ label: 'Refresh', onClick: refresh, variant: 'contained' }]}
      breadcrumbs={[
        { label: 'System', path: '/system' },
        { label: 'User Behavior Analytics', path: '/system/user-behavior-analytics' },
      ]}
    >
      {error && (
