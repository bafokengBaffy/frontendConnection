...
const Notifications = () => {
  const notifications = [
    {
      ...
      message:
        'Your application for Software Developer at Tech Solutions has moved to interview stage',
      time: '2 hours ago',
      type: 'application',
      read: false,
    },
  ...
  const getNotificationIcon = (type) => {
    switch (type) {
      case 'application':
        return 'bi-briefcase text-primary';
      case 'academic':
  ...
  const getTypeBadge = (type) => {
    switch (type) {
      case 'application':
        return <Badge bg="primary">Application</Badge>;
      case 'academic':
      ...
      default:
        return <Badge bg="secondary">Notification</Badge>;
    }
  };
