...
const ValueChainAnalyzer = () => {
  const { overview, models, insights, history, loading, error, refresh } = useCollaboration();
  ...
  return (
    <PageContainer
      ...
      subtitle="Cross-role value chain insights"
      loading={loading}
      actions={[{ label: 'Refresh', onClick: refresh, variant: 'contained' }]}
      breadcrumbs={[
        { label: 'Collaboration', path: '/collaboration' },
        { label: 'Value Chain Analyzer', path: '/collaboration/value-chain-analyzer' },
      ]}
    >
      {error && (
...
export default ValueChainAnalyzer;
