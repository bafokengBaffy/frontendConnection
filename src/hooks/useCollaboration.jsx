...
export const useCollaboration = () => {
  ...
  const startConversation = useCallback(
    async (otherParticipant, conversationData = {}) => {
  ...
  const sendMessage = useCallback(
    async (content, attachments = [], type = 'text') => {
      ...
      try {
        ...
        const result = await communicationService.sendMessage(activeConversation.id, {
  ...
  const searchConversations = useCallback(
    async (searchTerm) => {
      ...
      try {
        ...
        const result = await communicationService.searchConversations(currentUser.uid, searchTerm);
  ...
  const addReaction = useCallback(
    async (messageId, reaction) => {
      ...
      try {
        await communicationService.addReaction(messageId, currentUser.uid, reaction);
      } catch (error) {
        setError(error.message);
      }
    },
  ...
  const deleteMessage = useCallback(
    async (messageId) => {
      ...
      try {
        await communicationService.deleteMessage(messageId, currentUser.uid);
      } catch (error) {
        setError(error.message);
      }
    },
