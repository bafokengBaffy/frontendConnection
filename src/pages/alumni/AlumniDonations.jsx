...
const AlumniDonations = () => {
  const { overview, models, insights, history, loading, error, refresh } = useAlumni();
  ...
  return (
    <PageContainer
      ...
      subtitle="Donor trends and impact forecasting"
      loading={loading}
      actions={[{ label: 'Refresh', onClick: refresh, variant: 'contained' }]}
      breadcrumbs={[
        { label: 'Alumni', path: '/alumni' },
        { label: 'Alumni Donations', path: '/alumni/donations' },
      ]}
    >
      {error && (
